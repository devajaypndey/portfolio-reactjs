    ...
    return (
        <div className="min-h-screen flex flex-col bg-linear-to-br from-slate-950 via-indigo-950 to-slate-900 text-white">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-0 -left-1/4 w-96 h-96 bg-indigo-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDuration: '4s' }} />
                <div className="absolute bottom-0 -right-1/4 w-96 h-96 bg-violet-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDuration: '6s' }} />
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="hidden md:flex items-center gap-2">
                            ...
                            <a
                                ...
                                className="ml-2 p-2 text-white/70 hover:text-green-400 transition-all hover:scale-110"
                            >
                                <FaWhatsapp size={24} />
                            </a>
                        </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-3 gap-8 items-center">
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <p className="text-sm text-white/60">Building digital experiences that matter.</p>
                            <p className="text-xs text-white/40 mt-1">Gurugram, Haryana, India</p>
                        </div>
