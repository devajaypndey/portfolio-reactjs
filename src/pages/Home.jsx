...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-indigo-950 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 py-16 min-h-screen flex items-center">
        <div className="grid md:grid-cols-2 gap-12 items-center w-full max-w-6xl mx-auto">
          {/* LEFT */}
          <div
            className="space-y-8 animate-fade-in text-center md:text-left 
